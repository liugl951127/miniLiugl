...
export const upload = (data) => {
  console.log('%c[MARKETPLACE API] upload', 'color: #409eff', data)
  return http.post('/ai/marketplace/agents', data);
}
...
export const stats = () => {
  console.log('%c[MARKETPLACE API] stats', 'color: #409eff', '')
  return http.get('/ai/marketplace/stats');
}
