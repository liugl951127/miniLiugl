...
// V6.8.2+ 全局注册业务组件 (PageStandard / CrudTable / FormDrawer 等)
// 替代 87 view 重复的 import, 一处注册到处可用
...
// V6.8+ 前端日志上报 — mount 后给 Vue 补错误处理器
import { patchVueErrorHandler } from '@/composables/useClientLog'
setTimeout(() => patchVueErrorHandler(app), 0)
