<!--
  @file views/analytics/Nl2Sql.vue (V3.5.75 标准化模板)
...
import { nl2sqlAsk, nl2sqlExplain, _nl2qlFeedback, nl2sqlHistory, dryRunQuery } from '@/api/analytics'
