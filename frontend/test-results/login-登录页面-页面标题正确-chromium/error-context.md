...
- Name: login.spec.js >> 登录页面 >> 页面标题正确
- Location: e2e/login.spec.js:10:3
...
Expected pattern: /MiniMax/i
Received string:  "登录 - Liugl-AI"
Timeout: 10000ms

Call log:
  - Expect "toHaveTitle" with timeout 10000ms
    23 × locator resolved to <html lang="zh-CN">…</html>
       - unexpected value "登录 - Liugl-AI"
