...
- Name: navigation.spec.js >> 应用导航 >> 监控页面可访问
- Location: e2e/navigation.spec.js:46:3
...
Locator: locator('text=监控,text=健康,text=告警').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=监控,text=健康,text=告警').first()
