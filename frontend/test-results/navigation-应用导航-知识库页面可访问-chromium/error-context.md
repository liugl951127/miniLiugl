...
- Name: navigation.spec.js >> 应用导航 >> 知识库页面可访问
- Location: e2e/navigation.spec.js:28:3
...
Locator: locator('text=知识库,text=我的知识库').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=知识库,text=我的知识库').first()
