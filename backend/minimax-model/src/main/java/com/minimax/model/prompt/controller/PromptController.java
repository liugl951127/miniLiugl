package com.minimax.model.prompt.controller;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.minimax.common.result.Result;
import com.minimax.model.prompt.entity.PromptTemplate;
import com.minimax.model.prompt.service.PromptTemplateService;
...
public class PromptController {
    ...
    /**
     * V3.5.18+ 改: 删除自动 init (避免 schema 依赖)
     * 原因: H2 schema-locations 与 @PostConstruct / @EventListener 时序冲突
     * 改后: 内置模板通过 Flyway / 启动 SQL 加载 (生产 MySQL 数据已有, 沙箱用 data-locations)
     *       沙箱首次启动用 INSERT SQL 即可, 不需要 Bean 初始化逻辑
     */
    // init() 已移除 (V3.5.18+)
