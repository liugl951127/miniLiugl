...
@Service
/**
 * IntentService (V6.1 详细注释版)
 *
 * <h2>职责</h2>
 * 生成服务 - IntentService.java
 *
 * <h2>核心功能</h2>
 * <ul>
 *   <li>提供 IntentService 的业务能力</li>
 *   <li>参与 AI 平台整体架构</li>
...
public class IntentService {
     ...
     */
    /**
     * V6.8.1: 详细识别 (返回 RecognitionResult 含 score/model/alternatives)
     */
    public RecognitionResult recognizeWithDetails(String text, String sessionId) {
        KeywordEngine.Intent intent = recognize(text, sessionId);
        return new RecognitionResult(intent, 1.0);
    }
     ...
     * 识别结果 (LRU 缓存值)
     */
    public record RecognitionResult(KeywordEngine.Intent intent, double score) {
        public KeywordEngine.Intent getIntent() { return intent; }
        public double getScore() { return score; }
        public double getConfidence() { return score; }  // V6.8.1: 别名
        public String getModel() { return "rule-based"; }  // V6.8.1: 当前模型
        public List<KeywordEngine.Intent> getAlternatives() { return new ArrayList<>(); }  // V6.8.1: 备选
    }
}
