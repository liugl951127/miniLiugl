...
public class AiPlatformController {
    ...
    // ==================== AI 会话管理 (V6.8.1: 改名 /platform/chat/sessions 避免与 AiChatRealController 冲突) ====================

    /**
     * 列出某用户会话
     */
    @GetMapping("/platform/chat/sessions")
     ...
     * 获取会话详情 (含消息)
     */
    @GetMapping("/platform/chat/sessions/{id}")
     ...
     * 创建会话
     */
    @PostMapping("/platform/chat/sessions")
     ...
     * 删除会话
     */
    @DeleteMapping("/platform/chat/sessions/{id}")
