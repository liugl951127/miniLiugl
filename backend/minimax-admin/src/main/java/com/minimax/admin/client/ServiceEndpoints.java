...
public class ServiceEndpoints {
    ...
    private String chat;
    @Value("${minimax.admin.services.model:http://localhost:8084}")
    private String model;
    @Value("${minimax.admin.services.rag:http://localhost:8085}")
    private String rag;
    @Value("${minimax.admin.services.multimodal:http://localhost:8087}")
    private String multimodal;
    @Value("${minimax.admin.services.agent:http://localhost:8088}")
    private String agent;
    @Value("${minimax.admin.services.monitor:http://localhost:8089}")
    private String monitor;
    @Value("${minimax.admin.services.pipeline:http://localhost:8093}")
    private String pipeline;
    @Value("${minimax.admin.services.ai:http://localhost:8094}")
    private String ai;
    @Value("${minimax.admin.services.ws:http://localhost:8095}")
    private String ws;
    @Value("${minimax.admin.services.analytics:http://localhost:8092}")
