...
public class UserApiKeyController {
    ...
    @Audited(action = "TOGGLE_API_KEY", resourceType = "ApiKey", resourceId = "#id")
    ...
    @Audited(action = "DELETE_API_KEY", resourceType = "ApiKey", resourceId = "#id")
    @DeleteMapping("/{id}")
    ...
    @Audited(action = "ROTATE_API_KEY", resourceType = "ApiKey", resourceId = "#id")
