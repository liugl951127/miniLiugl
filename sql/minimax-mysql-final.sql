...
-- 角色 (先插角色，因为用户依赖 role)
INSERT IGNORE INTO `sys_role` (id, code, name, description, sort, enabled, created_at) VALUES
...
-- 租户
INSERT IGNORE INTO `tenant` (id, code, name, plan, status, max_users, max_models, qps_limit, monthly_quota, used_quota, expire_at, contact_email, data_isolation, ip_whitelist, is_default) VALUES
...
INSERT IGNORE INTO `sys_user` (id, username, password, nickname, email, phone, avatar, gender, status, last_login_ip, tenant_id, created_at) VALUES
...
-- API Key
INSERT IGNORE INTO `user_api_key` (id, user_id, name, key_hash, key_prefix, scopes, expires_at, last_used_at, use_count, enabled, created_at) VALUES
...
-- 通知
INSERT IGNORE INTO `notification` (id, user_id, type, title, content, is_read, created_at) VALUES
(1, 1, 'SYSTEM', '欢迎使用 MiniMax', '系统初始化完成，V6.8.2 版本已就绪', 0, '2026-01-01 00:00:00'),
(2, 2, 'SYSTEM', '账号激活',         '您的账号已激活，可以开始使用了', 1, '2026-01-02 00:00:00');

-- 登录日志
INSERT IGNORE INTO `auth_login_log` (id, user_id, username, ip, user_agent, status, message, created_at) VALUES
...
-- 模型提供商
INSERT IGNORE INTO `model_provider` (id, code, name, base_url, api_key, protocol, enabled, sort, description, created_at) VALUES
...
-- 模型配置
INSERT IGNORE INTO `model_config` (id, provider_id, model_code, display_name, max_context, max_output, input_price, output_price, supports_vision, supports_tools, supports_stream, enabled, sort, description, created_at) VALUES
-- OpenAI
...
-- 模型配额 (每个用户每天免费额度)
INSERT IGNORE INTO `model_quota` (id, user_id, model_id, quota_date, used_tokens, used_requests, limit_tokens, limit_requests, created_at, updated_at) VALUES
...
INSERT IGNORE INTO `chat_session` (id, user_id, title, model, system_prompt, temperature, status, message_count, last_message_at, tenant_id, created_at, updated_at) VALUES
...
INSERT IGNORE INTO `chat_message` (id, session_id, user_id, role, content, tokens, finish_reason, created_at) VALUES
...
INSERT IGNORE INTO `knowledge_base` (id, owner_id, tenant_id, name, description, visibility, doc_count, chunk_count, tags, created_at, updated_at) VALUES
...
INSERT IGNORE INTO `document` (id, kb_id, owner_id, title, source_type, source_uri, content, size_bytes, status, chunk_count, tags, created_at, updated_at) VALUES
...
INSERT IGNORE INTO `document_chunk` (id, doc_id, kb_id, owner_id, chunk_index, content, dim, char_count, start_pos, end_pos, access_count, created_at) VALUES
...
INSERT IGNORE INTO `plugin` (id, name, display_name, description, version, author, category, scope, owner_id, icon, entry, plugin_type, enabled, created_at) VALUES
...
INSERT IGNORE INTO `kg_entity` (id, user_id, name, entity_type, description, aliases, importance, source, ref_count, created_at, updated_at) VALUES
...
INSERT IGNORE INTO `kg_relation` (id, user_id, from_entity, to_entity, relation_type, description, weight, source, created_at) VALUES
...
INSERT IGNORE INTO `collab_session` (id, session_id, owner_id, title, status, max_users, created_at) VALUES
(1, 1001, 2, 'AI 产品评审', 'ACTIVE', 5, '2026-08-10 10:00:00');

INSERT IGNORE INTO `collab_member` (id, collab_id, user_id, role, joined_at) VALUES
...
INSERT IGNORE INTO `ai_chat_session` (id, session_id, user_id, username, title, model, status, intent, confidence, created_at) VALUES
...
INSERT IGNORE INTO `ai_chat_message` (id, session_id, role, content, created_at) VALUES
...
INSERT IGNORE INTO `ai_tool` (id, code, name, category, description, enabled, builtin, impl_type, impl_value, input_schema, created_at) VALUES
...
INSERT IGNORE INTO `billing_record` (id, record_id, user_id, record_type, amount_cents, currency, status, description, created_at) VALUES
...
INSERT IGNORE INTO `audit_log` (id, trace_id, user_id, username, action, resource_type, resource_id, method, path, response_status, created_at) VALUES
...
INSERT IGNORE INTO `alert_channel` (id, name, channel_type, target, config, enabled, priority, description, template, created_by, created_at) VALUES
...
INSERT IGNORE INTO `alert_rule` (id, name, description, metric_name, service, operator, threshold, severity, cooldown_minutes, enabled, tags, notify_channel, created_at) VALUES
...
INSERT IGNORE INTO `alert_event` (id, rule_id, channel_id, severity, message, metric_value, triggered_at, acknowledged, acknowledged_by, acknowledged_at, resolved_at) VALUES
...
INSERT IGNORE INTO `pipeline_workflow` (id, name, description, definition, version, status, create_by, update_by, create_time, update_time, deleted) VALUES
(1, 'RAG 问答流程', '{"nodes":[{"id":"1","type":"input","label":"用户问题"},{"id":"2","type":"rag","label":"知识检索"},{"id":"3","type":"llm","label":"生成回答"},{"id":"4","type":"output","label":"返回结果"}],"edges":[{"from":"1","to":"2"},{"from":"2","to":"3"},{"from":"3","to":"4"}]}', 1, 1, 1, 1, '2026-06-01 00:00:00', '2026-06-01 00:00:00', 0),
(2, 'Agent 任务流', '{"nodes":[{"id":"1","type":"input"},{"id":"2","type":"planner"},{"id":"3","type":"executor"},{"id":"4","type":"critic"},{"id":"5","type":"output"}],"edges":[{"from":"1","to":"2"},{"from":"2","to":"3"},{"from":"3","to":"4"},{"from":"4","to":"5"}]}', 1, 1, 1, 1, '2026-07-01 00:00:00', '2026-07-01 00:00:00', 0);

INSERT IGNORE INTO `skill_approval` (id, task_id, user_id, username, tool_name, risk_level, goal, tool_params, status, approver_id, approver_name, reason, created_at, updated_at) VALUES
...
INSERT IGNORE INTO `prompt_template` (id, name, description, category, content, variables, creator_id, creator_name, is_public, use_count, created_at, updated_at) VALUES
...
INSERT IGNORE INTO `admin_audit_log` (id, actor_id, actor_name, action, resource_type, resource_id, detail, result, ip, created_at) VALUES
...
INSERT IGNORE INTO `collab_room` (id, name, owner_id, status, max_participants, created_at) VALUES
(1, 'AI 评审室', 2, 1, 5, '2026-08-10 10:00:00');

INSERT IGNORE INTO `collab_participant` (id, room_id, user_id, role, joined_at) VALUES
(1, 1, 2, 'owner',  '2026-08-10 10:00:00'),
(2, 1, 1, 'member', '2026-08-10 10:05:00');

INSERT IGNORE INTO `collab_message` (id, room_id, user_id, content, message_type, created_at) VALUES
...
INSERT IGNORE INTO `analytics_datasource` (id, name, type, connection_config, status, created_at) VALUES
...
INSERT IGNORE INTO `analytics_report` (id, name, description, report_type, config, created_by, created_at) VALUES
...
INSERT IGNORE INTO `function_tool` (id, name, description, category, input_schema, output_schema, enabled, builtin, created_at) VALUES
...
INSERT IGNORE INTO `training_task` (id, user_id, model_name, corpus_path, n_layer, n_head, n_embd, block_size, max_iters, batch_size, learning_rate, status, progress, current_iter, created_at) VALUES
...
INSERT IGNORE INTO `training_metric` (id, task_id, iter, loss, accuracy, progress, lr, gpu_util, vram_gb, created_at) VALUES
...
INSERT IGNORE INTO `metric_snapshot` (id, service, metric_name, metric_value, recorded_at) VALUES
...
INSERT IGNORE INTO `sensitive_word` (id, word, category, level, action, enabled, created_at) VALUES
